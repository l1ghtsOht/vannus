export default function Nav() {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-center gap-8 px-6 py-3"
      ...
      <a href="/" className="font-bold text-[15px] text-white tracking-tight">Vannus</a>
      <a href="/static/tools.html" className="text-[13px] text-white/55 hover:text-white transition-colors">Tools</a>
      <a href="/static/differential.html" className="text-[13px] text-white/55 hover:text-white transition-colors">Diagnosis</a>
      <a href="/journey" className="text-[13px] text-white/55 hover:text-white transition-colors">Build My Stack</a>
      <a href="/static/manifesto.html" className="text-[13px] text-white/55 hover:text-white transition-colors">Methodology</a>
