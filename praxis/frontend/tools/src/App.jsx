...
function Footer() {
  return (
    <footer style={{ background: 'rgba(0,0,0,0.3)', borderTop: '1px solid rgba(255,255,255,0.06)', padding: '48px 40px 24px', marginTop: 40 }}>
      ...
      <div style={{ maxWidth: 800, margin: '32px auto 0', paddingTop: 20, borderTop: '1px solid rgba(255,255,255,0.06)', fontSize: 11, color: 'rgba(255,255,255,0.25)', textAlign: 'center' }}>&copy; 2026 Praxis AI LLC &middot; <a href="/static/privacy-policy.html" style={{ color: 'rgba(255,255,255,0.25)', textDecoration: 'none' }}>Privacy</a> &middot; <a href="/static/terms-of-service.html" style={{ color: 'rgba(255,255,255,0.25)', textDecoration: 'none' }}>Terms</a></div>
    </footer>
  );
}
