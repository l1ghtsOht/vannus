...
| Metric | Value |
|--------|-------|
| **Python modules** | 109 files, ~70,700 lines |
| **Tool catalog** | 246 curated AI tools with rich metadata |
| **API endpoints** | 493 REST routes via FastAPI |
| **Test coverage** | 645 tests across 15 test files, all passing |
| **Frontend** | 33 HTML/JS files (~14,960 lines), Liquid Glass UI |
| **Versions** | 22 major iterations (v1 → v22) |
| **Total LOC** | ~85,700 (Python + Frontend) |
| **Zero external ML deps** | All NLP, scoring, graph, and retrieval are zero-dependency |
| **Last auto-update** | 2026-03-08 15:56 UTC |
<!-- AUTO:STATS:END -->
...
<!-- AUTO:GIT:START -->
*(Auto-populated by auto_push.py)*
<!-- AUTO:GIT:END -->
...
- **493 API routes**, all functional
- **645 tests passing** across 15 files
- **109 Python modules**, ~70,700 lines
- **33 frontend files**, ~14,960 lines
- **22 major versions** (v1 → v22)
- Server runs on port 8000 via `uvicorn praxis.api:app --port 8000`
- Zero external ML dependencies — pure Python stdlib
<!-- AUTO:STATE:END -->
