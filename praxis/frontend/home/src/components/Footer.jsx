    ...
    <footer style={{ background: 'rgba(0,0,0,0.3)', borderTop: '1px solid rgba(255,255,255,0.06)', padding: '48px 40px 24px', marginTop: '40px' }}>
      <div className="grid grid-cols-3 gap-8 max-w-[800px] mx-auto max-[600px]:grid-cols-1">
        <div>
          ...
          <a href="/static/tools.html" className="block text-[13px] text-white/35 no-underline leading-8 hover:text-white/70 transition-colors">Tools</a>
          ...
          <a href="/static/journey.html" className="block text-[13px] text-white/35 no-underline leading-8 hover:text-white/70 transition-colors">Guided Journey</a>
        </div>
        <div>
        ...
        <div>
          ...
          <a href="/static/manifesto.html" className="block text-[13px] text-white/35 no-underline leading-8 hover:text-white/70 transition-colors">About</a>
          <a href="mailto:drake@aidashboard.co" className="block text-[13px] text-white/35 no-underline leading-8 hover:text-white/70 transition-colors">Contact</a>
        </div>
      </div>
      <div className="max-w-[800px] mx-auto mt-8 pt-5 text-center text-[11px] text-white/25" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
        © 2026 Praxis by AI Dashboard · aidashboard.co
      </div>
    </footer>
  );
}
